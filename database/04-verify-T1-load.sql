-- Verification Script for T1 Data Load
...
-- Weather: 1,123,619 records
-- Zdarzenie_na_trasie: 56,073 records

PRINT '=== T1 DATA LOAD VERIFICATION ===';
PRINT '';
...
PRINT 'Weather:             ' + CAST(@WeatherCount AS VARCHAR(20)) + ' (Expected: 1,123,619)';
...
SELECT
    ...
    AVG(temperatura) AS Srednia_Temperatura,
    AVG(ilosc_opadow) AS Srednia_Ilosc_Opadow
FROM Weather
GROUP BY typ_opadow
